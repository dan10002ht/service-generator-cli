...
program
  ...
  .option('-l, --language <language>', 'Programming language (java, go, js)', 'java')
...
program
  ...
  .action(() => {
    ...
    console.log('  service-generator new service --language=java --name=my-service');
    console.log('  service-generator new service --interactive');
  });
